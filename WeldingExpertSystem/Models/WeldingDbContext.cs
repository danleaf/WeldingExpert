...
{
    public class WeldingDbContext : System.Data.Entity.DbContext
    {
    ...
    public class DBInitializer : DropCreateDatabaseAlways<WeldingDbContext>
    {
        protected override void Seed(WeldingDbContext context)
        {
            context.Welders.Add(new Welder { SocialID = "123456789012345677", Name = "Joe Tang", BirthYear = 1990, Level = 5 });
            context.Users.Add(new User { UserName = "admin", Password = "admin", Role = (int)UserRole.管理员, RealName = "叶丹", WorkerID = 1 });
